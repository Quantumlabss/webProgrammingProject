$(document).ready(function () {
    $(".studioBtn button").click(function () {
        $(".studioContainer").addClass("show");
    });


    $(".close").click(function () {
        $(".studioContainer").removeClass("show");
    });

    $(".studioContainer").click(function (event) {
        if ($(event.target).hasClass("studioContainer")) {
            $(".studioContainer").removeClass("show");
        }
    });
});
